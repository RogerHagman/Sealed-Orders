...
- Unassigned ships become port workers and apply labor to shipyards first, then forts.
...
- Unassigned ships become port workers and apply labor to shipyards first, then forts, then trade guilds.
